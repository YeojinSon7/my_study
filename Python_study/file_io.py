...
# with open("C:/Users/405/my_study/Python_study/새파일.csv", 'w', encoding="utf-8") as f: #공공기관에서 제공하는 형태가 .csv이다 
#     f.write("날짜,날씨,기온\n")
#     f.write("20230424,맑음,10\n")
#     f.write("20230424,비,9\n")

# with open("C:/Users/405/my_study/Python_study/새파일.csv","r",encoding="utf-8") as f:
#     data = f.readlines()
#     print(data)

# 2개의 정수 입력받고 계산결과 저장하는 함수
# 그 결과를 add_result.txt 파일에 저장하는 함수 정의
# 함수 이름: add_write

# def add_write(a,b):
#     result = a+b
#     with open("C:/Users/405/my_study/Python_study/add_result.txt", 'w', encoding="utf-8") as f:
#         f.write(str(result))
# add_write(2,3)
...
# with open("C:/Users/405/my_study/Python_study/add_number.txt", 'r', encoding="utf-8") as f:
#   data = f.read()
#   a= int(data[0])
#   b= int(data[2])
#   print(a + b)
